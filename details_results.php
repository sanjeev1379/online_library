...
<body onload="document.reg.user_query.focus();">
    ...
    <div class="container"  id="bg_1">
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-left" style="margin-left:4%;">
          ...
          <li class="active"><a id="left" href="#">Student details</a></li>
           ...
           ?>
            <form name="reg" class="form-horizontal" style="margin-left:12%;" action="details_results.php?q=<?php echo $uemail ?>" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 <input type="search" name="user_query" class="form-control" id="text" value="<?php echo @$search_accession_query ?>" style="width:40%;">
                </div>
              </div>
             <div class="form-group" >
  ...
  //$pro_student_id=$row_pro['student_id'];
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <p class="form-control-static"><?php echo @$pro_reg_no ?></p>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Student Name :</label>
      <div class="col-sm-10">
        <p class="form-control-static"><?php echo @$pro_std_name ?></p>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Session :</label>
      <div class="col-sm-10">
        <p class="form-control-static"><?php echo @$pro_session ?></p>
      </div>
    </div>
    <div class="form-group">
<label class="control-label col-sm-2" for="email">Contact :</label>
<div class="col-sm-10">
  <p class="form-control-static"><?php echo @$pro_mobile_no ?></p>
</div>
</div>
           </form>
