...
if(isset($_POST['search'])){
  ...
  if(!empty($search_query)){
    ...
    echo "Error in query.. <br />";
        ...
        header("Location:accession_results.php?q=$uemail&user_query=".$search_query);
      }
    }else{
      echo "<script>alert('Please Enter a Valid Search!')</script>";
      echo  "<script>window.open('search_accession.php?q=$uemail','_self')</script>";
    }
}
    ...
    <div class="container"  id="bg_1">
      ...
      <div class="navbar-collapse" id="mainNavBar">
        <ul class="nav navbar-nav navbar-left" style="margin-left:4%;">
          <li class="active"><a id="left" href="search_accession.php?q=<?php echo $uemail ?>">Search by Accession number</a></li>
        ...
        <div class="modal-content" style="width:88.5%;margin-top:-1.7%;margin-left:5.8%;" id="bg_form">
          <div class="modal-body">
            ...
            ?>
            <form name="reg" class="form-horizontal" style="margin-left:12%;" action="accession_results.php?q=<?php echo $uemail ?>" method="post">
...
?>
          <hr color="black" />
          <form class="form-horizontal" style="margin-left:12%;">
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
         ...
         <div class="col-sm-10">
          <p class="form-control-static"><?php echo @$pro_row_no ?></p>
        </div>
        </div>
      <div class="form-group">
       <label class="control-label col-sm-2" for="email">column no :</label>
       <div class="col-sm-10">
        <p class="form-control-static"><?php echo @$pro_column_no ?></p>
      </div>
      </div>
   </form>
  </div>
